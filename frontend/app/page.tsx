...
const DEFAULT_CURVE = [0.16, 1, 0.3, 1];

export default function Home() {
  return (
    <div className="min-h-screen bg-background-primary selection:bg-white/10 selection:text-white">
      <Header />
      ...
      <main className="max-w-7xl mx-auto px-6 py-20 lg:py-32">
        ...
        <section className="mb-32">
          <div className="flex flex-col md:flex-row gap-16 lg:gap-32">
            <motion.div 
              ...
              transition={{ duration: 0.8, ease: DEFAULT_CURVE }}
              className="flex-1"
            >
              ...
              <h1 className="text-6xl lg:text-8xl font-semibold tracking-tighter leading-[0.85] text-primary mb-12">
                Digital <br />
                <span className="text-muted">Market Research.</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-8 items-center">
                <Link
                  href="/market"
                  className="px-8 py-4 bg-white text-black font-bold text-xs uppercase tracking-[0.2em] rounded-sm hover:bg-muted transition-all active:scale-95"
                >
                  Launch Terminal
                </Link>
            ...
            <motion.div 
              ...
              transition={{ duration: 1, delay: 0.2, ease: DEFAULT_CURVE }}
              ...
              <div className="widget-block p-8 h-full flex flex-col justify-between">
                ...
                <div className="mt-12 pt-12 border-t border-border/60">
                  <p className="text-xs text-secondary leading-relaxed mb-4 italic">
                    "Data-driven insights for the modern skin investor. Every metric grounded in high-resolution asset history."
                  </p>
        ...
        <section className="mb-32">
          <div className="flex items-end justify-between mb-12">
            <div>
              <span className="font-data text-[10px] font-bold uppercase tracking-[0.3em] text-muted mb-3 block">
                [01] MARKET_PULSE
              </span>
        ...
        <section className="mb-32">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link 
              href="/market" 
              className="text-[10px] font-bold uppercase tracking-[0.2em] text-white hover:text-muted transition-colors underline underline-offset-8"
            >
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-20 pt-12 border-t border-border/20 flex flex-col md:flex-row justify-between gap-6">
            <p className="text-[10px] font-data text-muted uppercase tracking-[0.2em] font-bold">
              © 2026 DATA TERMINAL — ALL RIGHTS RESERVED.
            </p>
...
function FeatureWidget({ id, title, description }: { id: string; title: string; description: string }) {
  return (
    <div className="widget-block p-8 flex gap-8 group">
      <div className="font-data text-[12px] font-bold text-muted border border-border w-12 h-12 rounded-sm flex items-center justify-center bg-background-tertiary group-hover:text-primary group-hover:border-primary transition-all">
        {id}
      </div>
      <div>
        <h3 className="text-lg font-semibold text-primary mb-3 tracking-tight group-hover:text-white transition-colors">
          {title}
        </h3>
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <ul className="flex flex-col gap-3">
        {links.map(link => (
          <li key={link}>
            <Link href="#" className="text-[11px] font-bold text-muted hover:text-primary transition-colors uppercase tracking-widest">
              {link}
            </Link>
          </li>
        ))}
